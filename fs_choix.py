...
def fs_choix ():
    ...
    print("4. Fonction Spéciale Ultime (En BETA)\n")
    choice = input("Choix : ")
...
def la_fin_v1():
    os.system ("cls")
    liste = [
        {"nom": "MESNAGE", "prenom": "Dylan", "jour": "13", "mois": "10", "annee": "2007", "num": "", "email": "", "favori": "True", "groupe": "1"},
        {"nom": "GORLAS", "prenom": "Maxime", "jour": "16", "mois": "08", "annee": "2007", "num": "", "email": "", "favori": "True", "groupe": "1"}
    ]
    ecriture_csv ("data_contacts.csv", liste)
...
def fs_ultime():
    ...
    time.sleep(1)
    liste = []
    liste.append({"nom": "MESNAGE", "prenom": "Dylan", "jour": "13", "mois": "10", "annee": "2007", "num": "", "email": "", "favori": "True", "groupe": "1"})
    liste.append({"nom": "GORLAS", "prenom": "Maxime", "jour": "16", "mois": "08", "annee": "2007", "num": "", "email": "", "favori": "True", "groupe": "1"})
    ecriture_csv ("data_contacts.csv", liste)
    os.system ("cls")
